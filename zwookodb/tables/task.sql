...
CREATE TABLE `task` (
  ...
  CONSTRAINT `task_ibfk_3` FOREIGN KEY (`asset_id`) REFERENCES `asset` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `task_ibfk_4` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON UPDATE CASCADE
